...
function getBinaryPromise(e) {
  if ('file:' === window.location.protocol)
    return new Promise((r, t) => {
      let n = btoa(encodeURI(`site-lib/scripts/${e}`))
      window.addEventListener('DOMContentLoaded', () => {
        const e = document.getElementById(n)
        if (e) {
          const t = Uint8Array.from(
            Array.from(atob(JSON.parse(decodeURI(atob(e.value))).data)).map(e => e.charCodeAt(0))
          )
          r(t)
        }
      })
...
function instantiateArrayBuffer(e, r, t) {
  return getBinaryPromise(e)
    .then(e => (console.log('loaded wasm from', e), WebAssembly.instantiate(e, r)))
    .then(t, e => {
      err(`failed to asynchronously prepare wasm: ${e}`), abort(e)
    })
}
function instantiateAsync(e, r, t, n) {
  return instantiateArrayBuffer(r, t, n)
}
...
var calledRun,
  ...
  __emscripten_memcpy_js = (e, r, t) => HEAPU8.copyWithin(e, r, r + t),
  _abort = () => {
    abort('')
  },
  readEmAsmArgsArray = [],
    ...
    for (readEmAsmArgsArray.length = 0; (t = HEAPU8[e++]); ) {
      ...
      ;(r += (n &= 112 != t) && r % 8 ? 4 : 0),
        readEmAsmArgsArray.push(
          112 == t ? HEAPU32[r >> 2] : 105 == t ? HEAP32[r >> 2] : HEAPF64[r >> 3]
        ),
        (r += n ? 8 : 4)
    }
  ...
  ccall = (e, r, t, n, o) => {
    var a = {
      string: e => {
        var r = 0
        return null != e && 0 !== e && (r = stringToUTF8OnStack(e)), r
      },
      array: e => {
    ...
    if (n)
      for (var c = 0; c < n.length; c++) {
        var l = a[t[c]]
        l ? (0 === u && (u = stackSave()), (s[c] = l(n[c]))) : (s[c] = n[c])
      }
    var d = i(...s)
    return (d = (function (e) {
      return (
  ...
  cwrap = (e, r, t, n) => {
    ...
    return 'string' !== r && o && !n ? getCFunc(e) : (...o) => ccall(e, r, t, o, n)
  },
  wasmImports = {
  ...
  ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports.g)(),
  _SetBatchFractionSize = (Module._SetBatchFractionSize = e =>
    (_SetBatchFractionSize = Module._SetBatchFractionSize = wasmExports.h)(e)),
  _SetAttractionForce = (Module._SetAttractionForce = e =>
    (_SetAttractionForce = Module._SetAttractionForce = wasmExports.i)(e)),
  _SetLinkLength = (Module._SetLinkLength = e =>
    (_SetLinkLength = Module._SetLinkLength = wasmExports.j)(e)),
  _SetRepulsionForce = (Module._SetRepulsionForce = e =>
    (_SetRepulsionForce = Module._SetRepulsionForce = wasmExports.k)(e)),
  _SetCentralForce = (Module._SetCentralForce = e =>
    (_SetCentralForce = Module._SetCentralForce = wasmExports.l)(e)),
  _SetDt = (Module._SetDt = e => (_SetDt = Module._SetDt = wasmExports.m)(e)),
  _Init = (Module._Init = (e, r, t, n, o, a, i, s, u, c, l, d) =>
    (_Init = Module._Init = wasmExports.n)(e, r, t, n, o, a, i, s, u, c, l, d)),
  _Update = (Module._Update = (e, r, t, n) =>
    (_Update = Module._Update = wasmExports.o)(e, r, t, n)),
  _SetPosition = (Module._SetPosition = (e, r, t) =>
    (_SetPosition = Module._SetPosition = wasmExports.p)(e, r, t)),
  _SetSettleness = (Module._SetSettleness = e =>
    (_SetSettleness = Module._SetSettleness = wasmExports.q)(e)),
  _FreeMemory = (Module._FreeMemory = () => (_FreeMemory = Module._FreeMemory = wasmExports.r)()),
  _malloc = (Module._malloc = e => (_malloc = Module._malloc = wasmExports.t)(e)),
  _free = (Module._free = e => (_free = Module._free = wasmExports.u)(e)),
  __emscripten_stack_restore = e => (__emscripten_stack_restore = wasmExports.v)(e),
  __emscripten_stack_alloc = e => (__emscripten_stack_alloc = wasmExports.w)(e),
  _emscripten_stack_get_current = () => (_emscripten_stack_get_current = wasmExports.x)(),
  ___cxa_increment_exception_refcount = e =>
    (___cxa_increment_exception_refcount = wasmExports.__cxa_increment_exception_refcount)(e),
  ___cxa_is_pointer_type = e => (___cxa_is_pointer_type = wasmExports.__cxa_is_pointer_type)(e)
function run() {
  function e() {
    calledRun ||
      ((calledRun = !0),
